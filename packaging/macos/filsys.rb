...
class Filsys < Formula
  ...
  url "https://github.com/moebiusV/filsys/releases/download/v2.3.0/filsys-2.3.0.tar.gz"
  sha256 "a1e30cb529579225a5fce79bbe77d208c5d90bc14e4032571ae23d72cfcddb55"
  # ISC (see COPYING).
  license "ISC"
